...
class _AmountDueHeader extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return FulusCard(child: Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
...
class _PaymentRow extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) => Padding(padding: const EdgeInsets.symmetric(vertical: 2), child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
    Text(label, style: AppTypography.body.copyWith(color: AppColors.textSecondaryOf(context))),
    Flexible(child: Text(formatMoney(value, symbol: symbol), maxLines: 1, overflow: TextOverflow.ellipsis, textAlign: TextAlign.right, style: (emphasized ? AppTypography.subheading : AppTypography.body).copyWith(color: emphasized ? AppColors.primaryOf(context) : AppColors.textPrimaryOf(context), fontFeatures: const [FontFeature.tabularFigures()]))),
  ]));
}
...
class _PaymentMethodTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(onTap: onTap, borderRadius: BorderRadius.circular(AppRadius.md), child: Container(
