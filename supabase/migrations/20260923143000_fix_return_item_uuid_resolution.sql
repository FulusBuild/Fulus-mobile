-- Fix UUID-safe return item resolution.
-- The preceding migration used min(uuid), which PostgreSQL does not provide.
-- Keep the historical migration immutable and apply this correction separately.
