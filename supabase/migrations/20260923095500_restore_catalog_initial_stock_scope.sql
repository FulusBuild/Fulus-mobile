-- Restore the product-initial-stock-aware catalog mutation function after idempotency scope hardening.
-- Also preserve the later canonical sync entity name and qualified change-feed query.
